...
class MealList extends Component {
      ...
      return (
        <tr key={meal.id} >
          ...
          <td>
            ...
            <a className="btn-transparent red-text" onClick={ () => { _self.props.deleteMeal(meal, _self.props.profile) } }><i className="material-icons">delete</i></a>
          </td>
        </tr>
      );
    });
  ...
  move(page) {
    ...
    this.props.fetchMeals(this.props.profile, { ...filter, page, size: this.props.page.size });
  }
