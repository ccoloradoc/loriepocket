...
create table user (id bigint generated by default as identity, created_by varchar(255), creation_date timestamp, last_modified_by varchar(255), last_modified_date timestamp, firstname varchar(255), lastname varchar(255), password varchar(255), username varchar(255), calories integer not null, primary key (id));
